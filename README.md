...
A lightweight CNN model for classifying images using TensorFlow/Keras. Includes preprocessing, training, and evaluation with datasets like MNIST/CIFAR-10.
